<?php
/**
 * EK_Product_Cat_List_Walker class
 *
 * @package EKCategoryFitler\Includes
 * @version 1.0.0
 */

defined( 'ABSPATH' ) || exit;

if ( class_exists( 'EK_Product_Cat_List_Walker', false ) ) {
	return;
}
 ...
 */
class EK_Product_Cat_List_Walker extends Walker {
